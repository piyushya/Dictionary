...
search_btn.addEventListener('click', function () {
  var search_txt = search_bar.value;
...
function getMeaning(_x) {
  return _getMeaning.apply(this, arguments);
}
function _getMeaning() {
  _getMeaning = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(word) {
    var response, data, definitions, i, part_result, definition_heading, definition_text, example_heading, example_text;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          for (i = 0; i < definitions.length; ++i) {
            part_result = document.createElement('div');
            part_result.setAttribute('class', 'part_result');
            definition_heading = document.createElement('h2');
            definition_heading.textContent = "Definition ".concat(i + 1, " :");
            definition_text = document.createElement('p');
            definition_text.textContent = definitions[i].definitions[0].definition;
            example_heading = document.createElement('h3');
            example_heading.textContent = "Example :";
            example_text = document.createElement('p');
